        ...
        <div class="container py-2">
            <div class="row py-4">
                ...
                <div class="col-lg-4 d-flex align-items-center justify-content-center justify-content-lg-end">
                    <nav id="sub-menu">
                        <ul>
                            <li><i class="fas fa-angle-right"></i><a href="page-faq" class="ml-1 text-decoration-none">
                                    FAQ's</a></li>
                            <li><i class="fas fa-angle-right"></i><a href="sitemap" class="ml-1 text-decoration-none">
                                    Sitemap</a></li>
