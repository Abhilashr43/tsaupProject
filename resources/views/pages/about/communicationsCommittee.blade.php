                ...
                <div class="col-lg-9 col-xl-6 text-center">
                    ...
                    <div class="overflow-hidden mb-3">
                        <h2 class="text-color-dark font-weight-bold pb-2 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="250">Development & Communications
                            Committee
                        </h2>
                    </div>
                    <p class="font-weight-light text-color-dark line-height-9 text-4 pb-2 mb-4 appear-animation"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450">To assists the ITF, its
                        national members, and its Instructors to develop and manage their business.</p>
                </div>
            </div>
