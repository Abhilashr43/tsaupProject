                ...
                <div class="col-lg-9 col-xl-6 text-center">
                    ...
                    <div class="overflow-hidden mb-3">
                        <h2 class="text-color-dark font-weight-bold pb-2 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="250">Children’s Development
                            Committee
                        </h2>
                    </div>
                    <p class="font-weight-light text-color-dark line-height-9 text-4 pb-2 mb-4 appear-animation"
                        ...
                        Committee is to provide advice and support concerning the involvement of children within the ITF, in
                        particular with regards to physical, mental and emotional development, through the practise of
                        Taekwon-Do.

                        Also, to promote the teaching of character education which is consistent with the Taekwon-Do moral
                        culture as described by the founder General Choi Hong Hi.</p>
                </div>
            </div>
