                ...
                <div class="col-lg-9 col-xl-6 text-center">
                    ...
                    <div class="overflow-hidden mb-3">
                        <h2 class="text-color-dark font-weight-bold pb-2 mb-0 appear-animation"
                            data-appear-animation="maskUp" data-appear-animation-delay="250">Tournament Committee</h2>
                    </div>
                    <p class="font-weight-light text-color-dark line-height-9 text-4 pb-2 mb-4 appear-animation"
                        data-appear-animation="fadeInUpShorter" data-appear-animation-delay="450">To ensure the quality of
                        the organization at World Tournaments. </p>
                </div>
            </div>
