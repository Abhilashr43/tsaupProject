            ...
            <div class="col-lg-6">
                ...
                <div class="overflow-hidden mb-1">
                    <h2 class="font-weight-normal text-7 mt-2 mb-0 appear-animation" data-appear-animation="maskUp"
                        data-appear-animation-delay="200"><strong class="font-weight-extra-bold">Complaint</strong> Center
                    </h2>
                </div>
                <div class="overflow-hidden mb-4 pb-3">
                    <p class="mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">
                        Complaints Registration and Monitoring System</p>
                </div>

                <form class="contact-form" action="/complaint" method="POST">
            ...
            <div class="col-lg-6">
                ...
                <div class="appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="800">
                    ...
                    <ul class="list list-icons list-icons-style-2 mt-2">
                        <li><i class="fas fa-map-marker-alt top-6"></i> <strong class="text-dark">Address:</strong> Hanuman
                            Mandir Rd, Bichhiya Railway Colony, Gorakhpur, Uttar Pradesh 273014</li>
                        <li><i class="fas fa-phone top-6"></i> <strong class="text-dark">Phone:</strong> 9451980340</li>
                        <li><i class="fas fa-envelope top-6"></i> <strong class="text-dark">Email:</strong> <a
                                href="mailto:mail@example.com">complaint@tsaup.org</a></li>
                    </ul>
                    <p>
                        Complaint Regarding Sexual Harashment
                    </p>
                </div>
            </div>
        </div>
